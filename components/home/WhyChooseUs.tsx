    ...
    <section ref={containerRef} className="bg-brand-cream/60 py-24 md:py-32 bg-grid-pattern relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          {/* Left Column: Storytelling & Action (Sticky) */}
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 lg:pt-4">
            {FEATURES.map((feat, idx) => {
              ...
              // Determine translate offset for staggered look
              ...
              return (
                <motion.div
                  ...
                  className={`bg-white rounded-3xl p-7 border border-slate-100/80 shadow-md transition-all duration-300 hover:shadow-xl hover:border-slate-200/50 hover:-translate-y-2 group flex flex-col justify-between ${
